const products = [
  ...
  },
  {
    ...
    publishingDate: "01/09/2021",
    description:
      "1908, dans un square d’Aurillac, Marie-Hélise, enfant de l’assistance, fait deux rencontres qui vont bouleverser sa vie : une gitane, allaitant au sein son nourrisson et, plus loin, un vieil homme, Pierre Destourbe, veuf qui a perdu son fils, avec son chien Padouille. Ce trio tisse des liens qui provoquent chez Pierre Destourbe une grande émotion. Mais cette complicité nouvelle va créer un certain malaise.",
    mediaUrl:
  ...
  },
  {
    ...
    publishingDate: "01/09/2021",
    description:
      "Timothy, jeune auteur de polar, est interpellé par le FBI afin qu’il apporte son aide pour arrêter un dangereux criminel. D’abord dubitatif, il se laisse convaincre quand on l’invite à rejoindre un programme secret qui révèle et décuple les intuitions. Il se retrouve embarqué dans une course contre la montre qui le conduit à apprivoiser ce pouvoir méconnu mais accessible à tous, un pouvoir qui nous montre la vie telle qu’elle est véritablement : extraordinaire. Saurez-vous vous fier à vos propres intuitions pour résoudre l’enquête ?  ",
    mediaUrl:
  ...
  },
  {
    ...
    publishingDate: "01/09/2021",
    description:
      "Jeune femme volontaire, Soline est pisteuse-secouriste et maître-chien d’avalanche en Haute-Savoie. Animée par une farouche volonté d’indépendance, elle se consacre à son travail guidée par un don qui lui permet d’avoir des visions de personnes en péril. Mais une mystérieuse personne tente d’éloigner d’elle tous ceux qui lui témoignent de l’affection. Et si tout était lié à l’accident dont elle a été victime dans sa petite enfance, et qui l’a laissée sans aucun souvenir de ses origines ?",
    mediaUrl:
